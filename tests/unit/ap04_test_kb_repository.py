...
def test_load_formats():
 l=KnowledgeBaseLoader();assert l.load_file(KB/'KB-RULE-001_v1.0.0.json').source_format=='json';assert l.load_file(KB/'KB-RULE-002_v1.0.0.md').source_format=='markdown'
...
def test_duplicate():
 l=KnowledgeBaseLoader();x=l.load_file(KB/'KB-RULE-001_v1.0.0.json');r=KnowledgeBaseRepository();r.add(x)
